    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <form action="{{ route('category.index') }}" method="GET" class="d-flex" style="width: 300px;">
                <input type="text" name="search" class="w-75 pr-10 border-gray-300 rounded-md shadow-sm focus:border-blue500 focus:ring focus:ring-blue-200 me-2" placeholder="Cari..." value="{{ request('search') }}">
